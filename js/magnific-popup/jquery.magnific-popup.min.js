...
; (function (factory) {
	...
	MagnificPopup.prototype = {
		...
		_hasScrollBar: function (winHeight) {
			return ((mfp.fixedContentPos === 'auto' ? winHeight > _document.height() : !mfp.fixedContentPos) && $('html').css('overflow-y') === 'scroll');
		},
	...
	$.magnificPopup = {
		...
		defaults: {
			...
			overflowY: 'auto', // 'auto', 'hidden', 'overlay', 'scroll', 'visible'
	...
	$.fn.magnificPopup = function (instanceOptions) {
		...
		var jqOpts = { options: instanceOptions || {}, index: 0, items: this };

		return this.each(function () {
			var itemOpts = $.extend({}, jqOpts.options, $(this).data()),
				instance = $.magnificPopup.open(itemOpts);

			$(this).data('magnificPopup', instance);
		});
	};
	 ...
	 * Public functions
	 */
	$.magnificPopup.open = function (options, index) {
		_checkInstance();
		if (!options)
			options = {};
